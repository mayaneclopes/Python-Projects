...
age = input("How old are you? ").strip().lower()
city = input("What city do you live? ").strip().title()
profession = input("What is your profession? ").strip().lower()
hobby = input("What is your favorite hobby? ").strip().lower()
